...
#ifndef KINETMINUTES_SWIFT_H
#define KINETMINUTES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KinetMinutes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12KinetMinutes11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC12KinetMinutes10DetailView")
@interface DetailView : NSView
- (nonnull instancetype)initWithFrame:(NSRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

@interface DetailView (SWIFT_EXTENSION(KinetMinutes)) <NSTextViewDelegate>
@end

@class NSWindow;
SWIFT_CLASS("_TtC12KinetMinutes23LibraryWindowController")
@interface LibraryWindowController : NSWindowController <NSWindowDelegate>
- (nonnull instancetype)init;
- (void)reload;
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
- (NSRect)window:(NSWindow * _Nonnull)window willPositionSheet:(NSWindow * _Nonnull)sheet usingRect:(NSRect)rect SWIFT_WARN_UNUSED_RESULT;
...
@class NSTableView;
@class NSTableColumn;
@interface LibraryWindowController (SWIFT_EXTENSION(KinetMinutes)) <NSTableViewDataSource, NSTableViewDelegate>
...
SWIFT_CLASS("_TtC12KinetMinutes15MeetingRecorder")
@interface MeetingRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC12KinetMinutes11PrivacyPane")
@interface PrivacyPane : NSView
- (nonnull instancetype)initWithFrame:(NSRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

@class NSTextContainer;
SWIFT_CLASS("_TtC12KinetMinutes16TimelineTextView")
@interface TimelineTextView : NSTextView
